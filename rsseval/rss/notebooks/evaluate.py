...
'''
python main.py --dataset kandinsky --model kanddpl --n_epochs 10 --lr 0.001 --seed 123 --batch_size 256 --exp_decay 0.99 --c_sup 1 --task patterns --backbone conceptizer --tuning\
    --batch_size 256 --exp_decay 0.99 --c_sup 1 --task patterns --backbone conceptizer
